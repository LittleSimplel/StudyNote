<audio title="65 _ 迭代器模式（上）：相比直接遍历集合数据，使用迭代器有哪些优势？" src="https://static001.geekbang.org/resource/audio/1d/5d/1d607e6d414f08f04b2e5b4b5f5a8d5d.mp3" controls="controls"></audio> 
