<audio title="58 _ 模板模式（上）：剖析模板模式在JDK、Servlet、JUnit等中的应用" src="https://static001.geekbang.org/resource/audio/74/b6/74b4161b42a466d1ee2eefd6327066b6.mp3" controls="controls"></audio> 
