<audio title="54 _ 享元模式（上）：如何利用享元模式优化文本编辑器的内存占用？" src="https://static001.geekbang.org/resource/audio/35/68/35f47cc3ddc2134caefb978d60ef8a68.mp3" controls="controls"></audio> 
