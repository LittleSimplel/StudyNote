<audio title="56 _ 观察者模式（上）：详解各种应用场景下观察者模式的不同实现方式" src="https://static001.geekbang.org/resource/audio/93/13/93b41626690bbc806d4af3a72b473313.mp3" controls="controls"></audio> 
