<audio title="26 _ 有哪些招惹麻烦的性能陷阱？" src="https://static001.geekbang.org/resource/audio/ef/a7/ef356b1b8a3237a9283b8249b360dda7.mp3" controls="controls"></audio> 
<p>前面，我们讨论了改善代码性能的最基本的办法。接下来，我们讨论一些最佳实践，让我们先从一些容易被忽略的性能陷阱开始。</p><h2>使用性能测试工具</h2><p>今天我们的讲解需要用到一个工具，它就是JMH。JMH是为Java语言或者其他基于JVM的编程语言设计的一个基准测试工具。这一节，我们会使用这个工具来分析一些性能的陷阱。这里我们简单地介绍下，这个工具该怎么使用。</p><p>第一步，使用Maven工具建立一个基准测试项目（需要使用Maven工具）：</p><pre><code>$ mvn archetype:generate \
