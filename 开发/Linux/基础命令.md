...
- 开启防火墙 端口
  ...
  ```
  firewall-cmd --zone=public --add-port=443/tcp --permanent;firewall-cmd --reload;
  firewall-cmd --zone=public --add-port=9020/tcp --permanent;firewall-cmd --reload;
  firewall-cmd --zone=public --add-port=9995/tcp --permanent;firewall-cmd --reload;
  firewall-cmd --zone=public --add-port=9201/tcp --permanent;firewall-cmd --reload;
  firewall-cmd --zone=public --add-port=9301/tcp --permanent;firewall-cmd --reload;
  firewall-cmd --zone=public --add-port=9010/tcp --permanent;firewall-cmd --reload;
