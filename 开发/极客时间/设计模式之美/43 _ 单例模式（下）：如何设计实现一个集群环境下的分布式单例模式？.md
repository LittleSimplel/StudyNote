<audio title="43 _ 单例模式（下）：如何设计实现一个集群环境下的分布式单例模式？" src="https://static001.geekbang.org/resource/audio/a3/f4/a3fe2116433692f4cd0bbd3dffd91ff4.mp3" controls="controls"></audio> 
